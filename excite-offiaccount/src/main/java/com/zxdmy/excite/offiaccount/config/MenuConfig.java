...
public class MenuConfig {
    ...
    protected static WxMenu getMenu() {
        ...
        button1.setUrl(wxMpService.getOAuth2Service().buildAuthorizationUrl("", "snsapi_base", ""));
        ...
        button21.setUrl(wxMpService.getOAuth2Service().buildAuthorizationUrl("", "snsapi_base", ""));

        WxMenuButton button22 = new WxMenuButton();
        button22.setType(WxConsts.MenuButtonType.VIEW);
        button22.setName("收入统计");
        button22.setUrl(wxMpService.getOAuth2Service().buildAuthorizationUrl("", "snsapi_base", ""));

        WxMenuButton button23 = new WxMenuButton();
        button23.setType(WxConsts.MenuButtonType.VIEW);
        button23.setName("发布商品");
        button23.setUrl(wxMpService.getOAuth2Service().buildAuthorizationUrl("", "snsapi_base", ""));
    ...
    public static void main(String[] args) {
        MainConfig mainConfig = new MainConfig("wxf33dd15c03a05edd", "6865f84a88d51320c2f897678a7142eb", "chenxiuhao", "111");
        WxMpService wxMpService = mainConfig.wxMpService();
        try {
